...
Download [`AwesomeKeys.zip`](https://github.com/mobily/awesome-keys/releases/download/v1.2.0/AwesomeKeys-v1.2.0.spoon.zip), unzip and open `AwesomeKeys.spoon` (it will auto-install the spoon).
